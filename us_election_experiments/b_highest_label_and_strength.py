...
df = pd.read_csv(r"E:\Projects\DSI Gihan Prev\us_election_experiments\processed_preds\processed_trump_biden_all.csv")
...
df.to_csv(r"E:\Projects\DSI Gihan Prev\us_election_experiments\results\processed_trump_biden_all_maxes.csv")